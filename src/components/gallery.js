      ...
      <AnimatePresence mode="wait">
        {data && data.length > 0 ? (
          <motion.div
            ...
            drag="x" // drag=x sur le conteneur por activer le glissement horizontal
            dragConstraints={{ left: 0, right: 0 }} // dragConstraints={{ left: 0, right: 0 }} empêche le glissement hors des limites
            dragElastic={0.9} //  pour contrôler l'élasticité du glissement.
            ...
            <m.div
              className={`card-container ${isMobile ? 'mobile' : 'desktop'}`}>
              {data[currentIndex] && (
                <Card
